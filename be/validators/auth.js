...
const validateRegisterUser = () => {
  return [
    ...
    check('confirm_password', 'Confirm password không để trống').not().isEmpty(),
    check('confirm_password', 'Confirm password dài ít nhất 6 ký tự').isLength({ min: 6 }),
    check('confirm_password', 'Confirm password phải giống với password').custom(
      (value, { req }) => {
